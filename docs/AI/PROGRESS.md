...
> B1 fixes (D4-F1, D4-F2, D3-C1..C3, D5-C3) landed as the first B2 commits. B2 (D1+D6+D7) is now handed over for review. B3 (D2+D8+Security) has started immediately per the pipelining rule.
...
| 02 Logic - D2 Catalog | `results/02-D2-catalog.md` | IN-PROGRESS (B3) | - | - |
...
| 02 Logic - D8 Misc | `results/02-D8-misc.md` | IN-PROGRESS (B3) | - | - |
