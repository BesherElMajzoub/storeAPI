...
> Reviewer round 4: D5 APPROVED with conditions C1–C3 (first D4 commit). Next: D4 Inventory. Open owner decision: L-PAY-010 (D3).
...
| 02 Logic — D4 Inventory | `results/02-D4-inventory.md` | IN-PROGRESS | — | 2 decisions |
