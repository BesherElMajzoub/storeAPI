...
Status: READY-FOR-REVIEW (final verification rerun completed; awaiting independent review).
...
| Full suite run 1 | `244 passed (1390 assertions)` |
| Full suite run 2 | `244 passed (1390 assertions)` |
| Full suite run 3 | `244 passed (1390 assertions)` |
...
| Newman (actual collection) | `39 requests, 39 test scripts, 42 prerequest scripts, 66 assertions; failed: 0` |
...
- Newman command: `npx newman run postman_collection.json --env-var base_url=http://127.0.0.1:8000 --reporters cli --disable-unicode`.
